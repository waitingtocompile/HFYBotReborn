...
namespace HFYBot
{
    ...
    class Program
    {
        ...
        public const string version = "1.3 beta";

        //Shown at the bottom of each comment below a horizontal line to provide information about the bot.
        public const string footer = "This comment was automatically generated by HFYBotReborn version "
            + Program.version
        ...
        //Another thread for mail checking and stuff. This one runs every 10 minutes instead of every 30.
        ...
        static void Main(string[] args)
        {
            ...
            mailThread = new Thread(new ThreadStart(Subscriptions.SubscriptionManager.Run));
